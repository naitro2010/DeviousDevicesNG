...
bool Function HasKeywords(actor akActor)
	if !libs.AllowGenericEvents(akActor, libs.zad_DeviousBlindfold)
		return false
	else
...
Function Execute(actor akActor)
	int encounter =  Utility.RandomInt(0,2)
	; Beartrap
	...
	Elseif choice == 0 ; Investigate
		...
		if encounter == 1; Valuables
			...
			EndIf
		ElseIf encounter == 1
			Libs.NotifyPlayer("Suddenly you feel a sharp sting and pain begins to flow through your body. You try to back away, but your muscles refuse to obey and you collapse on the ground.",true)
